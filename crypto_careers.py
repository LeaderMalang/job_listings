...
while True:
    try:
        ...
        #job_urls=driver.find_elements(By.XPATH,'//div[@class="panel-body"]/ul/li[@class="job-listing"]/div[2]/div/a')
        job_urls=driver.find_elements(By.XPATH, '//div[@class="panel-body"]/ul[@class="jobList"]/li/div[2]/div/a')
        ...
        for job_url in job_urls:
            ...
            slug_url=current_url.rsplit('/', 1)[-1]
            #job_slug=driver.find_element(By.CSS_SELECTOR,'.jobDetail-headerIntro').text
            job_title=driver.find_element(By.CSS_SELECTOR,'.jobDetail-headerIntro').text
            ...
            #createIfNotExist(slug_url,job_title)
            #time.sleep(5)
            driver.close()
        ...
        nextLink = driver.find_element(By.CSS_SELECTOR, '.jobs-pagination ul.pagination li a[rel="next"]')
        nextLink.click()
