...
class CryptojobsSpider(scrapy.Spider):
    ...
    start_urls = ['https://crypto.jobs/?page=2']
    ...
    def parse(self, response):
        ...
        #     if url:
        #
        #         yield scrapy.http.Request(url=url, callback=self.single_parse)
        ...
        if nextUrl:
            ...
            yield scrapy.http.Request(url=nextPageUrl,headers=header, callback=self.single_parse)
